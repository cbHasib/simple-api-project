...
function displayTodos(todos){
    ...
    for(const todo of todos){
        ...
        if(completed == true){
            div.innerHTML = `<div id="alert-border-${id}"
            class="flex items-center p-4 mb-3 bg-green-100 border-t-4 border-green-500 dark:bg-green-200" role="alert">
            ...
            <div class="flex justify-between items-center w-full">
                ...
                <div class="mx-3 text-md text-green-700 font-bold">
                    Task Completed
                </div>
            </div>
            <button type="button"
                ...
                onclick="document.getElementById('alert-border-${id}').classList.add('hidden')" aria-label="Close">
            ...
            div.innerHTML = ` <div id="alert-border-${id}" class="flex items-center p-4 mb-3 bg-red-100 border-t-4 border-red-500 dark:bg-red-200"
            role="alert">
            ...
            <div class="flex justify-between items-center w-full">
                ...
                <div class="mx-3 text-md text-red-700 font-bold">
                        Task Pending
                </div>
            </div>
